  ...
  return (
    <>
      <div className="flex flex-col md:flex-row max-w-[93%] md:max-w-[70%] mx-auto mb-6">
        ...
        <div className="shadow-[#00000039] shadow-sm order-[0.1vw] border-secondary rounded-[1.6vw] md:rounded-[0.6vw] mt-[1.5vh] w-full md:w-[23vw] md:ml-[1.8vh] h-[103vw] md:h-[57vh] bg-primary">
