  ...
  return (
    <>
      <div className="flex flex-col md:flex-row max-w-[93%] md:max-w-[70%] mx-auto mb-6">
        <div className="shadow-[#00000039] shadow-sm flex flex-col justify-center items-center border-[0.1vw] border-secondary rounded-[1.6vw] md:rounded-[0.6vw] mt-[1.5vh] w-full md:w-[50vw] h-[20rem] md:h-[57vh] bg-primary p-[3vw] md:p-0">
          ...
          <div className="font-quicksand text-accent font-[500] text-justify mx-[2vw] text-[3vw] md:text-[1.1vw] leading-[28px] md:leading-[3.7vh]">
        ...
        <div className="shadow-[#00000039] shadow-sm order-[0.1vw] border-secondary rounded-[1.6vw] md:rounded-[0.6vw] mt-[1.5vh] w-full md:w-[23vw] md:ml-[1.8vh] h-[25rem] md:h-[57vh] bg-primary">
        <div className="mt-[3vh] md:mt-[4vh] mx-auto w-[16rem] md:w-[17vw] h-[16rem] md:h-[17vw] relative">
          <Image
